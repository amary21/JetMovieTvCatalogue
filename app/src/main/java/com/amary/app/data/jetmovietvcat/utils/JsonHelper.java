...
public class JsonHelper {
    ...
    public List<MovieResponse> loadMovies(){
        ...
        try {
            JSONObject object = new JSONObject(Objects.requireNonNull(parsingFileToString("MovieResponse.json")));
    ...
    public List<TvShowResponse> loadTvShows(){
        ...
        try {
            JSONObject object = new JSONObject(Objects.requireNonNull(parsingFileToString("TvShowsResponse.json")));
