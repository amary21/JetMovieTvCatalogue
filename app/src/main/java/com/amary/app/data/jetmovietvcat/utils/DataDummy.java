...
public class DataDummy {
    ...
    public static MovieEntity getMovieEntity(String movieId){
        for (int i =0; i <generateDummyMovies().size();i++){
            MovieEntity movieEntity = generateDummyMovies().get(i);
    ...
    public static TvShowEntity getTvShowEntity(String tvId){
        for (int i=0; i<generateDummyTvShows().size();i++){
            TvShowEntity tvShowEntity = generateDummyTvShows().get(i);
